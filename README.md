[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=2E9EF7&center=true&vCenter=true&width=500&lines=Hi+%F0%9F%91%8B+I'm+Rohit+Sircar;Data+Analyst;Python+%7C+SQL+%7C+Power+BI+Expert;Turning+Data+into+Decisions)](https://git.io/typing-svg)
...
- **Focus:** Customer segmentation, purchasing behavior, revenue insights

### ✈️ [British Airways Review Dashboard](https://github.com/RohitSircar45/British_Airways_Review)
Interactive Tableau dashboard visualizing British Airways customer review data.
- **Tech:** Tableau
- **Focus:** Sentiment trends, rating breakdowns, route performance
